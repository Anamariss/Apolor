  ...
  <section class="container-fluid pt-2">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card" style="width: 100;">
            <img src="media/Coro3.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card" style="width: 100;">
            <img src="media/Banda1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
              <span class="probootstrap-date"><i class="bi bi-calendar"></i>"#"</span>
        ...
        <div class="col-md-4">
          <div class="card" style="width: 100;">
            <img src="media/estudiantina1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
              <span class="probootstrap-date"><i class="bi bi-calendar"></i>"#"</span>
    ...
    <section class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-4 p-2">
          <div class="card" style="width: 100;">
            <img src="media/amalfi2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
              <span class="probootstrap-date"><i class="bi bi-calendar"></i>"#"</span>
        ...
        <div class="col-md-4 p-2">
          <div class="card" style="width: 100;">
            <img src="media/musica2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
              <span class="probootstrap-date"><i class="bi bi-calendar"></i>"#"</span>
    ...
    <section class="container-fluid pt-2">
      ...
      <section class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card" style="width: 100;">
              <img src="media/musica3.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                  card's
                  content.</p>
      ...
      <section class="container-fluid">
        <div class="row">
          <div class="col-md-4 p-2">
            <div class="card" style="width: 100;">
              <img src="media/estudiantina2.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                  card's
                  content.</p>
